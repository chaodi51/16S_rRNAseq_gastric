...
rule trimmomatic_pe:
  ...
  output:
    r1 = "../results/trimmed/{sample}_" + R1_SUF + "_trim.fastq",
    r2 = "../results/trimmed/{sample}_" + R2_SUF + "_trim.fastq",
    # reads where trimming entirely removed the mate
    r1_unpaired = "../results/trimmed/{sample}_1.unpaired.fastq",
    r2_unpaired = "../results/trimmed/{sample}_2.unpaired.fastq"
  log:
...
rule fastqc_trim:
  input:
    "../results/trimmed/{sample}_{num}_trim.fastq"
  output:
